...
public class IdempotentRequestAspect {
  ...
  public Object doPoint(ProceedingJoinPoint point, LocalIdempotentRequest localIdempotentRequest)
    ...
    // 可以直接返回, 也可以抛异常
    if (count >= 1) {
      log.error("接口请求太过频繁, PATH: {}, IP: {}", request.getRequestURI(), WebUtil.getIpAddr(request));
      return null;
    }
   ...
   */
  @Deprecated
  public Object doPointV0(ProceedingJoinPoint point, LocalIdempotentRequest localIdempotentRequest)
      throws Throwable {
